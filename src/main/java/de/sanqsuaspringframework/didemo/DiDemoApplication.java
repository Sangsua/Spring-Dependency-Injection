...
public class DiDemoApplication {
    ...
    controller.hello();
        System.out.println("Propertybased "+ ctx.getBean(PropertyInjectedController.class).sayHello());
        System.out.println("SetterBased "+ctx.getBean(SetterInjectedController.class).sayHello());
        System.out.println("Constructorbased "+ctx.getBean(ConstructorInjectedController.class).sayHello());
    }
